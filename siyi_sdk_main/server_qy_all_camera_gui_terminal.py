...
server_ip = "192.168.6.220" #"192.168.6.203"  # Update with your server IP
server_port = 5600
...
def create_gui():
    ...
    def lock_mode():
        ...
        msg = f'{selected_camera}_lock_mode'
        send_message(msg)
    ...
    def follow_mode():
        ...
        msg = f'{selected_camera}_follow_mode'
        send_message(msg)
    ...
    def zoom_in():
        ...
        msg = f'{selected_camera}_zoom_in'
        send_message(msg)
    ...
    def zoom_out():
        ...
        msg = f'{selected_camera}_zoom_out'
        send_message(msg)
    ...
    def absolute_zoom():
        ...
        msg = f'{selected_camera}_absolute_zoom'
        send_message(msg)
    ...
    def gimbal_rotation():
        ...
        msg = f'{selected_camera}_gimbal_rotation'
        send_message(msg)
    ...
    frame_home = tk.Frame(root,bg="#F5F5F5")
    ...
    '''
    btn_lock_mode = tk.Button(
        frame_home, text="Lock Mode",bg="#F5F5F5", command=lock_mode
    )
    btn_lock_mode.pack(side="left",padx=10,pady=10)

    btn_follow_mode = tk.Button(
        frame_home, text="Follow Mode",bg="#F5F5F5", command=follow_mode
    )
    btn_follow_mode.pack(side="left",padx=10,pady=10)


    frame_t = tk.Frame(root,bg="#F5F5F5")
    frame_t.grid(row=2, column=0, pady=10)  # Use grid instead of pack

    btn_zoom_in = tk.Button(
        frame_home, text="Zoom In",bg="#F5F5F5", command=zoom_in
    )
    ...
    btn_zoom_out = tk.Button(
        frame_home, text="Zoom Out",bg="#F5F5F5", command=zoom_out
    )
    ...
    btn_absolute_zoom = tk.Button(
        frame_home, text="Absolute Zoom ",bg="#F5F5F5", command=absolute_zoom
    )
    btn_absolute_zoom.pack(side="left",padx=10,pady=10)
    
    frame_t = tk.Frame(root,bg="#F5F5F5")
    frame_t.grid(row=2, column=0, pady=10)  # Use grid instead of pack
    
    btn_gimbal_rotation = tk.Button(
        frame_home, text="Gimbal Rotation",bg="#F5F5F5", command=gimbal_rotation
    )
    btn_gimbal_rotation.pack(side="left",padx=10,pady=10)
    
    frame_t = tk.Frame(root,bg="#F5F5F5")
    frame_t.grid(row=2, column=0, pady=10)  # Use grid instead of pack
    
    btn_center = tk.Button(
        frame_home, text="Center",bg="#F5F5F5", command=center
    )
    btn_center.pack(side="left",padx=10,pady=10)
    '''
    ...
    entry_label = tk.Label(frame_t, text="Enter host to ping:",bg="#F5F5F5")
    ...
    """
    # camera ....
    frame_camera = tk.Frame(root,bg="#F5F5F5")
    ...
    btn_back_home = tk.Button(frame_home, text="Exit",bg="#F5F5F5", command=root.quit)
