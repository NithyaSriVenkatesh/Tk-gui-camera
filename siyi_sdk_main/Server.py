...
import cv2
from angle_joystick import Joystick

# Define server IP and port
server_ip = "192.168.6.220"  # Update with your server IP
server_port = 5600
...
camera_ips = {
    "Cam1": "192.168.6.105",  # Update with your Cam1 IP
...
def create_gui():
    ...
    # Initialize and add the Joystick within frame_gimbal
    joystick = Joystick(frame_gimbal, control_callback=control_gimbal, width=200, height=200, bg='white')
    joystick.pack()
